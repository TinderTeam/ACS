...
namespace UnitTestProject
{
    ...
    public class ViewDaoCommonImplTest
    {
        ...
        {
            ViewDao<SystemUser> target = new ViewDaoCommonImpl<SystemUser>(); // TODO: 初始化为适当的值
            List<SystemUser> actual;
            actual = target.getAll();
            log.Error(actual);
        ...
        {
            ViewDaoCommonImpl<SystemUser> target = new ViewDaoCommonImpl<SystemUser>(); // TODO: 初始化为适当的值
            List<QueryCondition> conditionList = null; // TODO: 初始化为适当的值
            long actual;
            actual = target.getCount(conditionList);
            log.Error(actual);
